...
import { StyleSheet, View, Text, FlatList, ScrollView, TouchableOpacity, PixelRatio, Dimensions, } from 'react-native';
...
const CountryItem = (props) => {
    const { activeOpacity, itemHeight, flagSize, countryCodeFontStyle, } = useTheme();
    ...
    return (React.createElement(TouchableOpacity, Object.assign({ key: country.cca2, testID: `country-selector-${country.cca2}`, onPress: () => onSelect(country) }, { activeOpacity }),
        React.createElement(View, { style: [styles.itemCountry, { height: itemHeight }] },
            ...
            React.createElement(View, { style: styles.itemCountryName },
                React.createElement(CountryText, { numberOfLines: 2, ellipsizeMode: 'tail' }, country.name),
                React.createElement(CountryText, { numberOfLines: 1, ellipsizeMode: 'tail', allowFontScaling: false },
                    React.createElement(Text, { style: [styles.codeText, countryCodeFontStyle] },
                        ' ',
