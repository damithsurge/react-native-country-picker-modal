...
import { StyleSheet, PixelRatio, Text, View, ActivityIndicator, } from 'react-native';
...
const ImageFlag = memo(({ countryCode, flagSize }) => {
    ...
    return React.createElement(CountryFlag, { isoCode: countryCode.toLocaleLowerCase(), size: 20 });
});
